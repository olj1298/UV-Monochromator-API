...
"""Quantum Efficiency Measurement using picoammeter, filter wheel, NUVU controller."""
...
def get_qe_data():
    try:
        ...
        picoa=mclinux.picoammeter_initialize(Ch1ON,Ch2ON,interval,nsamples,picoasrl,debug=False) #intiallize picoammeter with the settings.
